...
def add_page_header_footer(doc, company_name):
    """Sets KARTA header/footer globally onto the document."""
    for section in doc.sections:
        header = section.header
        header_para = header.paragraphs[0]
        header_para.text = f"KARTA Credit Intelligence Platform | {company_name} | CONFIDENTIAL"
        ...
        footer_para.text = f"Generated by KARTA AI automatically. | Page "
...
def generate_cam(analysis_data: dict, field_observations: str = "") -> dict:
    ...
    doc.add_paragraph(f"Generated via KARTA AI Intelligence").alignment = WD_ALIGN_PARAGRAPH.CENTER
    doc.add_paragraph("\n\n")
    ...
    base_file_name = f"KARTA_CAM_{company_name.replace(' ', '_')}_{time.strftime('%Y%m%d')}"
